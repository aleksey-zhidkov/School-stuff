...
public class UntilLexemTest extends TestCase {
    ...
    public void testUntil() {
        try {
            ProgramContext context = new ProgramContext(ProgLanguage.PASCAL, PascalSharedData.REPEAT1);
            ...
            context = new ProgramContext(ProgLanguage.PASCAL, PascalSharedData.REPEAT1);
