...
public class PascalParserTest extends TestCase {
    ...
    public void testIfParse() {
        try {
            ILexem[] lexems = new PascalParser().parse(PascalSharedData.CONDITION1);
    ...
    public void testWhileParse() {
        try {
            ILexem[] lexems = new PascalParser().parse(PascalSharedData.WHILE1);
    ...
    public void testRepeat() {
        try {
            ILexem[] lexems = new PascalParser().parse(PascalSharedData.REPEAT1);
