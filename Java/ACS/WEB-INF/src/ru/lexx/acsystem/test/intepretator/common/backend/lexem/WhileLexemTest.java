...
public class WhileLexemTest extends TestCase {
    ...
    public void testWhile() {
        try {
            ProgramContext context = new ProgramContext(ProgLanguage.PASCAL, PascalSharedData.WHILE1);
            ...
            context = new ProgramContext(ProgLanguage.PASCAL, PascalSharedData.WHILE1);
