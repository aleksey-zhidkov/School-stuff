...
int main(int argc,char*argv []) {
  ...
  printf("Awaitng for connections\n");
  ...
  while((client_socket=accept(mysocket,(sockaddr *)&client_addr,&client_addr_size))) {
    ...
    DWORD thID;
    CreateThread(NULL,NULL,SexToClient2,&client_socket,NULL,&thID);
  }
  return 0;
}
